...
DEFAULT_CACHE_DB = DEFAULT_DATA_DIR / "cache.db"
DEFAULT_ARCHIVE_DB = DEFAULT_DATA_DIR / "archive_tweets.db"
DEFAULT_ADJACENCY_CACHE = DEFAULT_DATA_DIR / "adjacency_matrix_cache.pkl"
DEFAULT_CACHE_MAX_AGE_DAYS = 7
DEFAULT_SNAPSHOT_DIR = DEFAULT_DATA_DIR
