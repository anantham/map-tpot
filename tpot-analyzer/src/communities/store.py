...
Related modules (same package):
  preview.py    — rich per-account preview data assembly (UI queries)
  versioning.py — branch & snapshot versioning for Layer 2 state
"""
