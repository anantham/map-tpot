...
// Import utilities from ClusterView (we test these in isolation)
// Since they're not exported, we'll re-implement and test the logic

// =============================================================================
// Utility function tests (extracted logic from ClusterView)
// =============================================================================

describe('ClusterView Utility Functions', () => {
  // Helper functions matching ClusterView implementation
