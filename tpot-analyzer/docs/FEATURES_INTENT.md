...
- **Disk-friendly E2E**: Playwright is pinned to bundled `chromium` to avoid repeated Chrome-for-Testing installs and reduce disk use; headed/CI runs share the same cache path when configured.
